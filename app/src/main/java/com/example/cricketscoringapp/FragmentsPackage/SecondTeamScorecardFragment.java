...
public class SecondTeamScorecardFragment extends Fragment {
    ...
    public static SecondTeamScorecardFragment newInstance(String matchId) {
        SecondTeamScorecardFragment fragment = new SecondTeamScorecardFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_second_team_scorecard, container, false);

        battingTeamRecview = view.findViewById(R.id.batsmansrecyclerviewfinalscorecardteam2);
        bowlingTeamRecview = view.findViewById(R.id.bowlersrecyclerviewfinalscorecardteam2);
